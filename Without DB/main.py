import os
import discord
from discord_ui import Button, View, UserSelect, TextInput, Modal
from discord.ext import commands
import time

intents = discord.Intents.all()
bot = commands.Bot(command_prefix="$", intents=intents)  # Create a bot object
DISCORD_TOKEN = os.getenv("MTA4MzM2OTM3NzQ2MzgwODAwMA.GlOYco.xWe8tDC48UHrboJKT0ZmAb9J6_9GWojChA1zsE")
print("I'm online")
